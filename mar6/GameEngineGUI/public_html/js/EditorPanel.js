var EditorPanel = function(htmlParentID, name){
    ...
    this.initialize = function(){
        ...
        close.click(function() {
            ...
            //todo: this click function seems to only get called for edit object, and that code below doesn't work
    ...
    this.createButtons = function() {
        ...
        var update = $('<button type="button" id="editScriptUpdate">Edit Script (Update)</button>');
        this.panel.append(update);
        this.panel.append('<br>');
    };
