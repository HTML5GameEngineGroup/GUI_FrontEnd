...
alert("==============\nInstructions\n==============\n\nIn this test, you should download the file Class123.js I prepared and try to upload it.  Afterwards, click the Verify Class123 button to check that it works.\n\n==============");
...
var uploadJS = function() {
    ...
    var file = document.getElementById("menuTest").files[0];
    if (file) {
        
        // Only add new files
        if (file.name.endsWith(".js")) { // Make sure it is in a .js format
            // Add it to the list to keep a record of it
            gFileNames.push(file.name);
