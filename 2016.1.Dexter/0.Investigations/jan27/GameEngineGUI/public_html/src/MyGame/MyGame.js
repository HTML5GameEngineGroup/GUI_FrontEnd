...
/*global model: true, gEngine: false, Scene: false, BlueLevel: false, Camera: false, Renderable: false, vec2: false */
...
//    
     ...
     for (i = 0; i < Global_ObjectList.length; i++) {
        Global_ObjectList[i].draw(this.mCamera);
     } 
