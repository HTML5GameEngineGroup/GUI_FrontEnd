...
var classTest = function() {
    ...
    // Print the variables
    console.log(a.mNumber); // 30
    console.log(a.mPi);     // 3.14
    ...
    // Instantiate ClassB
    var b = new ClassB();
    // Test the inherited function
    b.test();               // 2
    // Override it now
    window["ClassB"].prototype["test"] = new Function("console.log(1);");
            
    b.test();               // 1
    console.log(b.mNumber); // 60
    console.log(b.mPi);     // 3.14
    
    console.log("===");     // Divider
    
    // Instantiate another ClassB to demonstrate that you can have multiple, different ClassBs
    var b2 = new ClassB();
    b2.mNumber = 70;
    console.log(b.mNumber);  // 60
    console.log(b2.mNumber); // 70
    
    //b["doubleMyNumber"] = new Function("return this.mNumber * 2;"); // This is what we would do if we wanted to add a function to only b
    //console.log(b.doubleNumber());
};
