...
$( "#fileSave" ).click(function() {
    ...
    // Store all the objects as their getAllContents() ARRAYS, offsetting the index by 2
    for(i = 0; i < Global_ObjectList.length; i++){
        data[i + 2] = Global_ObjectList[i].getAllContents();
    }    
    ...
    if (jsEditPanel.getVisible()) {
        ...
        button.click(function() {
            if (selectedContent === null) {
                ...
                selectedContent.setScriptUpdate(editor.getValue());
            }
        });
        ...
        // 7 = the update script
        editor.setValue(selectedContent.getAllContents()[8].value);
    }
});
...
var createDefaultGameObj = function (defaultName){
    ...
    selectedContent = new ObjectContent(selectedGameObject);
...
var updateEditView = function(/*name,x,y,rotation,w,h,color*/ contentList){
    ...
    // 7 = the update script
    if (editor !== null) {
        editor.setValue(contentList[8].value);
    }
};
...
var initialzeView = function(){
    ...
    objEditPanel.createComponent('Hex Color');
    objEditPanel.createComponent('Edit Script (Update)');
    objEditPanel.setVisible(true);
