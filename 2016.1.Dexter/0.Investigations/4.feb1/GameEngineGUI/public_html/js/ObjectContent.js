 ...
 */
var ObjectContent = function(referencedObj){
    ...
    this.getAllContents = function() {
        ...
        list[7] = new Content("Hex Color", this.object.getHexColor());
        // There are 2 places (besides fileLoad) in view.js that use a hard-coded value of 8 for the script.  Change them if needed.
        list[8] = new Content("Edit Script (Update)", this.object.getScriptUpdate());
        var i;
